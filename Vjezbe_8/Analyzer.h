...
// Mon Aug 24 09:56:10 2020 by ROOT version 6.22/00
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   void PlotMassDkin();
   void FitMassLikelihood();
   void FitMass();
   
   TTree *tree;
   TH1F *leptonPt[4], *leptonPhi[4], *leptonEta[4], *leptonBDT[4];
   TLegend* CreateLegend(TH1F*, TH1F*, TH1F*, TH1F*);
   TH1F *massHiggsSignal, *massHiggsBackground;
   TCanvas *c;
   float Dkin;
   TH1F *DkinBackground, *DkinSignal;
   TH2F *massDkinSignal, *massDkinBackground;
...
// used to generate this class and read the Tree.
    //c = new TCanvas("c","c");
    massHiggsSignal = new TH1F("higgsSignal","",50,70.,170.);
    massHiggsBackground = new TH1F("higgsBack","",50,70.,170.);
    DkinBackground = new TH1F("DkinBack","",100,0,1.);
    DkinSignal = new TH1F("DkinSignal","",100,0,1.);
    massDkinSignal = new TH2F("massDkinSignal","",50,70.,170.,10,0.,1.);
    massDkinBackground = new TH2F("massDkinBackground","",50,70.,170.,10,0.,1.);
}
